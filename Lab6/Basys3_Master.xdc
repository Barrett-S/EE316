...
set_property PACKAGE_PIN W5 [get_ports clk]							
    ...
    set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets signal_start_IBUF]
## Switches
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports signal_start]						
	set_property IOSTANDARD LVCMOS33 [get_ports signal_start]
